...
- Sound: all APU channels supported (pulse, triangle, noise, DMC).
- Two players; key mapping is configurable via **SETTINGS** (saved to `ASD.NES.Settings.xml` next to the executable).
